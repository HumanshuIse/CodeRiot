...
//                         <h2 className="text-4xl font-pixel text-white mb-4 bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent text-shadow-neon">Opponent Found!</h2>
...
//                 return (
//                     <div className="text-center animate-fade-in">
//                         <h2 className="text-3xl font-pixel text-white mb-4 text-shadow-neon">Searching for Opponent</h2>
